        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="flex flex-col items-start gap-2 mb-6">
              ...
              <span className="text-xl font-bold uppercase tracking-wide">Go Whale Shark Sumbawa</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 text-gray-300">
                ...
                <div>
                  ...
                  <p className="text-sm">Dusun Aipaya, Labuan Aji, Kecamatan Tarano, Kabupaten Sumbawa, Nusa Tenggara Barat - 84384</p>
                </div>
              </div>
              ...
              {/* Email */}
              <a href="mailto:gowhalesharksumbawa@gmail.com" className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm">gowhalesharksumbawa@gmail.com</p>
                </div>
              </a>

              {/* Instagram */}
              <a href="https://www.instagram.com/go_whaleshark.sumbawa" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm">@go_whaleshark.sumbawa</p>
                </div>
              </a>

              {/* TikTok */}
              <a href="https://www.tiktok.com/@go_whaleshark.sumbawa" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
