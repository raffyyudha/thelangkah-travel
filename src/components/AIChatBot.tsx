...
const INITIAL_MESSAGE: Message = {
  role: "assistant",
  content: "Halo! Saya AI Assistant dari Go Whale Shark Sumbawa. Ada yang bisa saya bantu tentang paket wisata kami? 😊"
};
      ...
      const response = await fetch("/api/chat", {
        ...
        body: JSON.stringify({
          messages: [
            {
              role: "system",
              content: `Kamu adalah AI customer service untuk Go Whale Shark Sumbawa, sebuah tour operator di Sumbawa, Indonesia. 
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-100">Go Whale Shark Sumbawa</p>
              </div>
            </div>
            <button
