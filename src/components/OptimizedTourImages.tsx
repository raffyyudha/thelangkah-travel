  ...
  useEffect(() => {
    async function loadImages() {
      try {
        ...
        // Fallback for transport-service if images are missing
        if (tourName === 'transport-service') {
          if (!imageMap.hero) imageMap.hero = '/images/transport-1.webp';
          if (!imageMap.gallery1) imageMap.gallery1 = '/images/transport-2.webp';
          if (!imageMap.gallery2) imageMap.gallery2 = '/images/transport-3.webp';
          if (!imageMap.gallery3) imageMap.gallery3 = '/images/transport-4.webp';
        }
