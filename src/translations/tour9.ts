export const tour9Translations = {
  id: {
    ...
    itinerary: {
      time1: "Hari 1 - 12.00",
      desc1: "Penjemputan dari hotel Anda di area Poto Tano, Taliwang, atau Kertasari. Memulai perjalanan indah menuju Desa Labuan Jambu.",
      time2: "18.00",
  ...
  en: {
    ...
    itinerary: {
      time1: "Day 1 - 12.00",
      desc1: "Pick up from your hotel in Poto Tano, Taliwang, or Kertasari area. Begin the beautiful journey to Labuan Jambu Village.",
      time2: "18.00",
