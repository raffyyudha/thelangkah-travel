export const tour10Translations = {
  id: {
    ...
    itinerary: {
      time1: "Hari 1 - 12.00",
      desc1: "Penjemputan dari hotel Anda di area Jelenga, Maluk, atau Sekongkang.",
      time2: "17.00",
      desc2: "Tiba di Desa Labuan Jambu dan check-in di Alffiah Hotel. Nikmati malam hari dengan waktu luang untuk bersantai atau menjelajahi desa. Jika Anda ingin makan, sopir kami akan siap mengantar Anda ke restoran terdekat (makanan atas biaya sendiri).",
      time3: "Hari 2 - 03.30",
      desc3: "Transfer ke kapal nelayan tradisional, berlayar menuju Whale Shark Point.",
      time4: "05.30",
    ...
    inclusions: [
      "Transportasi AC PP dari Jelenga, Maluk, atau Sekongkang ke Desa Labuan Jambu",
  ...
  en: {
    ...
    itinerary: {
      time1: "Day 1 - 12.00",
      desc1: "Pick up from your hotel in Jelenga, Maluk, or Sekongkang area.",
      time2: "17.00",
      desc2: "Arrive at Labuan Jambu Village and check-in at Alffiah Hotel. Enjoy the evening with free time to relax or explore the village. If you want to eat, our driver will be ready to take you to the nearest restaurant (food at your own expense).",
      time3: "Day 2 - 03.30",
      desc3: "Transfer to traditional fishing boat, sailing to Whale Shark Point.",
      time4: "05.30",
    ...
    inclusions: [
      "AC transportation round trip from Jelenga, Maluk, or Sekongkang to Labuan Jambu Village",
