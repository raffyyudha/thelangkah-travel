export const tour10Translations = {
  id: {
    ...
    itinerary: {
      time1: "Hari 1 - 12:00",
      desc1: "Penjemputan di hotel Anda di area Sekongkang, Maluk, atau Jelenga. Memulai perjalanan darat menuju Desa Labuan Jambu menggunakan mobil.",
      time2: "17:00",
      ...
      time6: "08:00",
      desc6: "Sarapan ringan akan disajikan di perahu (roti, kopi, teh, air dan buah segar).",
      time7: "08:30",
      desc7: "Kembali ke Desa Labuan Jambu.",
      time8: "10:00",
      desc8: "Tiba di Desa Labuan Jambu, istirahat sebentar di hotel sebelum melanjutkan perjalanan darat kembali ke area Sekongkang, Maluk, atau Jelenga.",
      time9: "15:00",
      desc9: "Tiba di area Sekongkang dan diantar kembali ke penginapan Anda. Program selesai.",
  ...
  en: {
    ...
    itinerary: {
      time1: "Day 1 - 12:00",
      desc1: "Pickup from your hotel in Sekongkang, Maluk, or Jelenga area for the land journey to Labuan Jambu Village by car.",
      time2: "17:00",
      ...
      time6: "08:00",
      desc6: "Light breakfast will be served on the boat (bread, coffee, tea, water, and fresh fruits).",
      time7: "08:30",
      desc7: "Return to Labuan Jambu Village.",
      time8: "10:00",
      desc8: "Arrive back in Labuan Jambu Village, take a short rest at the hotel before driving back to Sekongkang, Maluk, or Jelenga area.",
      time9: "15:00",
      desc9: "Arrive in the Sekongkang area and we will drop you off at your accommodation. End of program.",
