...
const translations = {
  id: {
    ...
    tourBPriceFrom: "Mulai 510.000 IDR per orang",
  ...
  en: {
    ...
    // Homepage Hero
    heroTitle: "Explore the Best of Sumbawa with Us",
    ...
    welcomeDesc: "Adventure Sumbawa Island is a local adventure travel service platform based in Sumbawa. We are here with a commitment to introduce the natural beauty of Sumbawa to the world through authentic, safe, comfortable, and eco-friendly travel experiences.\nWith an experienced local team, we offer carefully designed journeys, providing every guest the opportunity to enjoy Sumbawa more closely, naturally, and memorably.",
    ...
    tourB: "1 Day Whale Shark Trip (B)\n(Start & Finish Labuhan Jambu)",
    tourBPriceFrom: "Starting from 510,000 IDR per person",
    tourC: "1 Day Whale Shark Trip (C)\n(Using Speed Boat)",
