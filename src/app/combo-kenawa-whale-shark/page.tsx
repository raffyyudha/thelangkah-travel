...
export default function ComboKenawaWhaleSharkPage() {
  return (
    <main className="min-h-screen">
      ...
      <section className="relative h-[500px] flex items-center justify-start">
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-7xl">
          <div className="max-w-3xl">
            <div className="inline-block bg-gradient-to-r from-[#00a6b5] to-orange-500 text-white px-4 py-2 rounded-full font-semibold mb-4">
              PAKET KOMBINASI
            </div>
            ...
            <p className="text-white text-xl mb-6">
              Sunset di Kenawa dan berenang bersama hiu paus - kombinasi sempurna!
            </p>
            <div className="flex flex-wrap gap-4 text-white mb-8">
              ...
              <div className="flex items-center gap-2">
                <MapPin size={20} />
                <span>Kenawa & Labuhan Jambu</span>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="https://wa.me/6282341331975?text=Halo,%20saya%20ingin%20booking%20Combo%20Kenawa%20+%20Whale%20Shark"
                target="_blank"
      ...
      <section className="py-12 bg-white border-b">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="max-w-2xl mx-auto">
            <div className="bg-gradient-to-br from-[#00a6b5] via-orange-400 to-orange-500 text-white p-8 rounded-2xl text-center">
              <h3 className="text-lg font-semibold mb-2">Paket Kombinasi</h3>
              <div className="text-5xl font-bold mb-2">Rp 900K</div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg group">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <div className="text-4xl mb-2">🌅</div>
                <h3 className="text-white font-bold text-lg mb-1">Sunset Spektakuler</h3>
                <p className="text-white/90 text-sm">Sunset di Pulau Kenawa</p>
              </div>
            </div>
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg group">
              <Image
            ...
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg group">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <h3 className="text-white font-bold text-lg mb-1">Pantai Eksotis</h3>
                <p className="text-white/90 text-sm">Pasir putih Pulau Kenawa</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <ItineraryItem
              ...
              description="Pickup dari meeting point dan perjalanan ke Labuhan Jambu."
            />
            <ItineraryItem
              time="07:30"
              title="Berangkat ke Spot Whale Shark"
              description="Perjalanan dengan boat menuju spot hiu paus di Teluk Saleh."
            />
            <ItineraryItem
              time="08:30"
            ...
            <ItineraryItem
              ...
              description="Perjalanan menuju Pulau Kenawa untuk sunset tour."
            />
            <ItineraryItem
              time="15:00"
              title="Explore Kenawa & Snorkeling"
              description="Eksplorasi pulau, snorkeling, dan menikmati pantai pasir putih."
            />
            <ItineraryItem
              time="17:30"
              title="Sunset Time"
              description="Menikmati pemandangan sunset yang spektakuler."
            />
            <ItineraryItem
              time="18:30"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <IncludeItem text="Makan siang (menu lokal)" />
                <IncludeItem text="Snack & air mineral" />
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[#00a6b5] via-orange-400 to-orange-500 text-white">
        <div className="container mx-auto px-6 max-w-7xl text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Siap untuk Petualangan Seru?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Dapatkan pengalaman whale shark dan sunset Kenawa dalam satu paket hemat!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-white text-orange-600 px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-xl"
            >
              <MessageCircle size={24} />
              Book via WhatsApp
            </a>
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white hover:text-orange-600 transition-all transform hover:scale-105"
            >
              Tanya Detail
            </Link>
          </div>
  ...
  return (
    <div className="flex gap-6">
      <div className="flex-shrink-0">
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#00a6b5] to-orange-500 flex items-center justify-center text-white font-bold text-sm">
          {time}
        </div>
      </div>
