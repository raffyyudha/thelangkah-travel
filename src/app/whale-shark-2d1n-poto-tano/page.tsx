...
import { tour9Translations } from "@/translations/tour9";

export default function WhaleShark2D1NPotoTanoPage() {
  const { language } = useLanguage();
  const t = language === 'id' ? tour9Translations.id : tour9Translations.en;
  const { t: commonT } = useLanguage();
  const pageTitle = commonT.tourE;
    ...
    <main className="min-h-screen bg-white">
      <article className="pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <OptimizedTourImages tourName="whale-shark-2d1n-poto-tano" />
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
            ...
            <DynamicPricingTable tourName="whale-shark-2d1n-poto-tano" title={t.pricingTitle} />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <OptimizedRelatedToursGrid 
            tours={relatedTours} 
            currentTourName="whale-shark-2d1n-poto-tano"
          />
        </div>
      </section>
