        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-700 leading-relaxed">
                Go Whale Shark Sumbawa adalah operator wisata lokal yang berpengalaman di Sumbawa. Kami spesialis dalam pengalaman snorkeling dengan hiu paus di Teluk Saleh, Labuhan Jambu, serta eksplorasi pulau-pulau eksotis di sekitar Sumbawa.
              </p>
            </div>
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
              <PackageCard
