    ...
    <main className="min-h-screen bg-white">
      <article className="pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <OptimizedTourImages tourName="whale-shark-moyo-kenawa-lombok" />
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
            ...
            <DynamicPricingTable tourName="whale-shark-moyo-kenawa-lombok" title={t.pricingTitle} />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <OptimizedRelatedToursGrid 
            tours={relatedTours} 
            currentTourName="whale-shark-moyo-kenawa-lombok"
          />
        </div>
      </section>
