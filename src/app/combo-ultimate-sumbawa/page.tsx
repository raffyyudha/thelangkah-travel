...
export default function Page() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative h-[500px] flex items-center justify-start">
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-7xl">
          <div className="max-w-3xl">
            <div className="inline-block bg-gradient-to-r from-[#00a6b5] via-purple-500 to-orange-500 text-white px-4 py-2 rounded-full font-semibold mb-4">
              PAKET ULTIMATE
            </div>
            <h1 className="text-white text-5xl md:text-6xl font-bold mb-4">
              Ultimate Sumbawa Experience
            </h1>
            <p className="text-white text-xl mb-6">
              Moyo Island + Kenawa + Whale Shark - Paket lengkap terbaik Sumbawa
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="https://wa.me/6282341331975?text=Halo,%20saya%20ingin%20booking%20Ultimate%20Sumbawa%20Experience"
                target="_blank"
      ...
      <section className="py-12 bg-white border-b">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="max-w-2xl mx-auto">
            <div className="bg-gradient-to-br from-[#00a6b5] via-purple-500 to-orange-500 text-white p-8 rounded-2xl text-center">
              <h3 className="text-lg font-semibold mb-2">Paket Ultimate</h3>
              <div className="text-5xl font-bold mb-2">Rp 1.8 Juta</div>
              <p className="text-sm opacity-90">per orang (min. 4 pax)</p>
              <p className="text-xs opacity-80 mt-2">Hemat hingga 30% dibanding booking terpisah!</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Titik kumpul untuk trip ultimate</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg group">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <h3 className="text-white font-bold text-lg mb-1">Whale Sharks</h3>
            ...
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg group">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <div className="text-4xl mb-2">💧</div>
                <h3 className="text-white font-bold text-lg mb-1">Pulau Moyo</h3>
                <p className="text-white/90 text-sm">Air terjun & pantai eksotis</p>
              </div>
            </div>
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg group">
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <div className="text-4xl mb-2">🌅</div>
                <h3 className="text-white font-bold text-lg mb-1">Pulau Kenawa</h3>
                <p className="text-white/90 text-sm">Sunset spektakuler</p>
              </div>
            </div>
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-lg group">
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <p className="text-white/90 text-sm">3 spot snorkeling terbaik</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <ItineraryItem
                  time="14:00"
                  title="Free Time & Snorkeling"
                  description="Waktu bebas untuk snorkeling tambahan."
                />
                <ItineraryItem
                  time="16:00"
                  title="Kembali ke Penginapan"
                  description="Kembali ke penginapan dan istirahat."
                />
              </div>
            </div>

            <div>
              <h3 className="text-2xl font-bold mb-6 text-gray-900">Hari 3 - Pulau Kenawa</h3>
              <div className="space-y-6">
                <ItineraryItem
                  time="08:00"
                  title="Check-out & Berangkat"
                  description="Check-out dan perjalanan ke Pulau Kenawa."
                />
                <ItineraryItem
                  time="10:00"
                  title="Explore Kenawa"
                  description="Eksplorasi pulau dan snorkeling di air jernih."
                />
                <ItineraryItem
                  time="12:00"
                  title="Makan Siang"
                  description="Makan siang di pantai Kenawa."
                />
                <ItineraryItem
                  time="14:00"
                  title="Beach Time"
                  description="Waktu bebas di pantai pasir putih."
                />
                <ItineraryItem
                  time="16:00"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <IncludeItem text="Penginapan 2 malam" />
                <IncludeItem text="Peralatan snorkeling lengkap" />
                <IncludeItem text="Guide profesional" />
                <IncludeItem text="Semua makan (3x makan siang, 2x makan malam, 2x sarapan)" />
                <IncludeItem text="Air mineral & snack" />
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[#00a6b5] via-purple-500 to-orange-500 text-white">
        <div className="container mx-auto px-6 max-w-7xl text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Siap untuk Petualangan Ultimate?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Dapatkan pengalaman lengkap terbaik Sumbawa dalam satu paket hemat! 3 destinasi, 3 hari petualangan tak terlupakan.
          </p>
  ...
  return (
    <div className="flex gap-6">
      <div className="flex-shrink-0">
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#00a6b5] via-purple-500 to-orange-500 flex items-center justify-center text-white font-bold text-sm">
          {time}
        </div>
      </div>
