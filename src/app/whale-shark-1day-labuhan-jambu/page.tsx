...
export default function WhaleShark1DayLabuhanJambuPage() {
  ...
  const pageTitle = commonT.tourB;
  
  const [currentReview, setCurrentReview] = useState(0);
  const [isBookingModalOpen, setIsBookingModalOpen] = useState(false);
  // Related tours configuration for optimized loading (only 6 active tours)
  const relatedTours = [
    {
    ...
    },
    {
      ...
      title:
        language === "id"
          ? "Layanan Transportasi ( Antar & Jemput )"
          : "Transport Service ( Pick-up & Drop-off )",
    ...
    <main className="min-h-screen bg-white">
      <article className="pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <OptimizedTourImages tourName="whale-shark-1day-labuhan-jambu" />
          ...
          <div className="prose prose-lg max-w-none">
            ...
            {t.highlightsTitle && (
              <>
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">{t.highlightsTitle}</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-700 mb-8">
                  {t.highlights && t.highlights.map((item, index) => (
            ...
            <div className="mb-4">
              <p className="text-gray-900 font-bold mb-1">{t.itinerary.time1}</p>
              <p className="text-gray-700 leading-relaxed whitespace-pre-line ml-4">{t.itinerary.desc1}</p>
            </div>

            <div className="mb-4">
              <p className="text-gray-900 font-bold mb-1">{t.itinerary.time2}</p>
              <p className="text-gray-700 leading-relaxed whitespace-pre-line ml-4">{t.itinerary.desc2}</p>
            </div>

            <div className="mb-4">
              <p className="text-gray-900 font-bold mb-1">{t.itinerary.time3}</p>
              <p className="text-gray-700 leading-relaxed whitespace-pre-line ml-4">{t.itinerary.desc3}</p>
            </div>

            <div className="mb-4">
              <p className="text-gray-900 font-bold mb-1">{t.itinerary.time4}</p>
              <p className="text-gray-700 leading-relaxed whitespace-pre-line ml-4">{t.itinerary.desc4}</p>
            </div>

            <div className="mb-4">
              <p className="text-gray-900 font-bold mb-1">{t.itinerary.time5}</p>
              <p className="text-gray-700 leading-relaxed whitespace-pre-line ml-4">{t.itinerary.desc5}</p>
            </div>

            {t.itinerary.time6 && (
              <div className="mb-8">
                <p className="text-gray-900 font-bold mb-1">{t.itinerary.time6}</p>
                <p className="text-gray-700 leading-relaxed whitespace-pre-line ml-4">{t.itinerary.desc6}</p>
              </div>
            )}
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
            ...
            <DynamicPricingTable tourName="whale-shark-1day-labuhan-jambu" title={t.pricingTitle} />

            <div className="my-8">
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 text-center">
                {language === 'en' ? 'Open Trip Price' : 'Harga Paket Open Trip'}
              </h3>
                ...
                <table className="w-full border-collapse rounded-lg overflow-hidden shadow-md">
                  <thead>
                    <tr className="bg-green-600 text-white">
                      ...
                      <th className="py-4 px-6 text-left font-bold text-sm md:text-base">{commonT.tourOpenTrip}</th>
                    </tr>
                  </thead>
            ...
            {/* Customer Reviews Slider (hidden) */}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <OptimizedRelatedToursGrid 
            tours={relatedTours} 
            currentTourName="whale-shark-1day-labuhan-jambu"
          />
        </div>
      </section>
