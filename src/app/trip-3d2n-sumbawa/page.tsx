      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="bg-gradient-to-br from-[#00a6b5] to-[#0a3d52] rounded-2xl p-8 text-white mb-12">
            <h2 className="text-3xl font-bold mb-6">Paket 3 Hari 2 Malam</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-center gap-3">
                <Calendar className="w-6 h-6" />
                <div>
                  <p className="text-sm opacity-90">Durasi</p>
                  <p className="font-bold">3 Hari 2 Malam</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold">Best of Sumbawa</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-4 border-[#00a6b5] pl-6">
                <h4 className="font-bold text-lg mb-2">Hari 2: Moyo Island</h4>
                <p className="text-gray-700">Eksplorasi Pulau Moyo dan air terjun eksotis</p>
              </div>
              <div className="border-l-4 border-[#00a6b5] pl-6">
                <h4 className="font-bold text-lg mb-2">Hari 3: Kenawa Sunset & Departure</h4>
                <p className="text-gray-700">Sunset di Pulau Kenawa dan persiapan keberangkatan</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700">Akomodasi 2 malam</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-green-500 flex items-center justify-center flex-shrink-0 mt-1">
                  <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="bg-gray-50 rounded-2xl p-8 text-center">
            ...
            <p className="text-4xl font-bold text-[#00a6b5] mb-6">IDR 3.800.000</p>
            <p className="text-gray-600 mb-6">Per Orang (Min. 2 pax)</p>
            <a
              href="https://wa.me/6282341331975?text=Halo,%20saya%20ingin%20booking%20Trip%203D2N%20Sumbawa"
              target="_blank"
