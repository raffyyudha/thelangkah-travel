    ...
    <main className="min-h-screen bg-white">
      <article className="pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <OptimizedTourImages tourName="trip-4d3n-sumbawa" />
          ...
          <div className="prose prose-lg max-w-none">
            ...
            {t.description3 && <p className="text-gray-700 leading-relaxed mb-8">{t.description3}</p>}

            {t.highlightsTitle && (
              <>
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">{t.highlightsTitle}</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-700 mb-8">
                  {t.highlights && t.highlights.map((item: string, index: number) => (
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">{t.day4Title}</h3>
            {t.day4Items && t.day4Items.map((item: string, index: number) => (
              <p 
            ...
            <DynamicPricingTable tourName="trip-4d3n-sumbawa" title={t.pricingTitle} />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <OptimizedRelatedToursGrid 
            tours={relatedTours} 
            currentTourName="trip-4d3n-sumbawa"
          />
        </div>
      </section>
