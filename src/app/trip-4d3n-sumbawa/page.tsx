...
export default function Trip4D3NSumbawaPage() {
  ...
  const t = language === 'id' ? tour5Translations.id : tour5Translations.en;
      ...
      <article className="pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Sumbawa Tour 4 Days 3 Nights
          </h1>

          {/* Featured Image - Dynamic from Database */}
          <DynamicTourImages tourName="trip-4d3n-sumbawa" />

          {/* Content */}
          <div className="prose prose-lg max-w-none">

            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              Sumbawa Tour Packages - Moyo Island, Whale Shark & Kenawa Island Experience #type A
            </h3>
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">1st Day - Exploring Moyo Island and Surroundings</h3>
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">2nd Day - Whale Shark Excursion</h3>
            ...
            <p className="text-gray-700 mb-2"><strong>6:00 AM</strong> – Dive into the unforgettable experience of swimming, snorkeling, and diving with whale sharks. Witness these gentle giants up close in their natural habitat.Light breakfast will be served on board, including bread, coffee, tea, and fresh fruit.</p>
            ...
            <p className="text-gray-700 mb-8"><strong>1:00 PM</strong> – Head towards the center of Sumbawa town for sightseeing and exploration.2:30 PM – Return to Samawa Seaside Resort for check-in and free time to relax by the pool or enjoy the seaside views. Dinner – Available at the resort's restaurant or at a local venue in central Sumbawa.</p>

            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Day 3 - Island Hopping of Kenawa, Paserang, Kambing Island</h3>
            <p className="text-gray-700 mb-2"><strong>8:00-10:00 AM:</strong> Depart from Sumbawa Town for a 2-hour road trip to Poto Tano Village.</p>
            <p className="text-gray-700 mb-2"><strong>10:15 AM – 1:30 PM:</strong> Embark on a boat trip to explore Kenawa Island and Paserang Island, where you can swim and snorkel in crystal-clear waters.</p>
            <p className="text-gray-700 mb-2"><strong>1:30 PM:</strong> Return to the main harbor and head for lunch at a local restaurant or warung.</p>
            <p className="text-gray-700 mb-2"><strong>3:00-5:00 PM:</strong> Begin your road trip back to Sumbawa Town and check in at your hotel near the airport.</p>
            <p className="text-gray-700 mb-2"><strong>6:00-7:00 PM:</strong> Enjoy a farewell dinner at the hotel restaurant.</p>
            <p className="text-gray-700 mb-8"><strong>7:00 PM:</strong> End of service and prepare for departure.</p>

            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Day 4:  Farewell - Transfer Out</h3>
            <p className="text-gray-700 mb-8"><strong>8:00-10:00 AM:</strong> Depart from Your Hotel & Transfer to airport. End of program</p>

            <h4 className="text-xl font-bold text-gray-900 mb-4">Inclusion</h4>
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-8">
              <li>3 night Hotel + Breakfast (AC & for 2 person/room)</li>
            ...
            <h4 className="text-xl font-bold text-gray-900 mb-4">What to bring during the Tour (optional)</h4>
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-8">
              <li>Jackets</li>
            ...
            <h4 className="text-xl font-bold text-gray-900 mb-4">Intrested with this Tour Program?</h4>
