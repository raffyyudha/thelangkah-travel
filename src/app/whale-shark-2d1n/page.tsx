    ...
    <main className="min-h-screen bg-white">
      <article className="pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <OptimizedTourImages tourName="whale-shark-2d1n" />
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-8">
              {t.day1Items?.map((item, idx) => (
                <div key={idx} className="mb-4">
                  <p className="text-gray-900 font-bold mb-1">{item.time}</p>
                  <div 
                    className="text-gray-700 leading-relaxed whitespace-pre-line ml-4"
            ...
            <DynamicPricingTable tourName="whale-shark-2d1n" title={t.pricingTitle} />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <OptimizedRelatedToursGrid 
            tours={relatedTours} 
            currentTourName="whale-shark-2d1n"
          />
        </div>
      </section>
