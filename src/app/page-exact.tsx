      ...
      <section className="relative h-[600px] flex items-center justify-start">
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-7xl">
          ...
          <p className="text-white text-lg md:text-xl max-w-2xl">
            Go Whale Shark Sumbawa merupakan operator wisata lokal terbaik yang menyediakan paket wisata ke Sumbawa, khususnya snorkeling dengan hiu paus di Labuhan Jambu
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-700 leading-relaxed">
                Paket wisata Sumbawa bersama Go Whale Shark Sumbawa dengan destinasi terlengkap dan pilihan paket wisata yang beragam. Dari snorkeling dengan hiu paus hingga eksplorasi pulau-pulau eksotis.
              </p>
            </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-700 leading-relaxed">
                Go Whale Shark Sumbawa adalah operator wisata lokal yang berpengalaman di Sumbawa. Kami spesialis dalam pengalaman snorkeling dengan hiu paus di Teluk Saleh, Labuhan Jambu.
              </p>
            </div>
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
              <PackageCard
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-700 leading-relaxed">
                Lihat momen-momen indah dari trip kami dan baca testimoni dari pelanggan yang puas dengan layanan Go Whale Shark Sumbawa.
              </p>
            </div>
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
              <PackageCard
      ...
      <section className="py-20 bg-[#003d4a] text-white">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <div className="mb-8">
                <h3 className="text-3xl font-bold mb-6">Go Whale Shark Sumbawa</h3>
      ...
      <footer className="bg-[#1a1a1a] text-gray-400 py-6">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="mb-4 md:mb-0">© 2025 Go Whale Shark Sumbawa</p>
