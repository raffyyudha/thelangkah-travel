    ...
    <main className="min-h-screen bg-white">
      <article className="pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          {/* Featured Image - Optimized from Database */}
          <OptimizedTourImages tourName="whale-shark-start-sumbawa" />
          ...
          <div className="prose prose-lg max-w-none">
            ...
            {[t.itinerary.time1, t.itinerary.time2, t.itinerary.time3, t.itinerary.time4, t.itinerary.time5, t.itinerary.time6, t.itinerary.time7, t.itinerary.time8]
              .filter(Boolean)
              .map((time, idx) => {
                ...
                const isLast = idx === 7 || ![t.itinerary.time6, t.itinerary.time7, t.itinerary.time8].filter(Boolean)[0] && idx === 4;
                return (
                  <p
                    key={`itinerary-${idx}`}
                    className={`text-gray-700 leading-relaxed ${isLast ? "mb-4" : "mb-2"}`}
                  >
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
            ...
            {/* Pricing Table - dynamic from database */}
            <DynamicPricingTable tourName="whale-shark-start-sumbawa" title={t.pricingTitle} />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <OptimizedRelatedToursGrid 
            tours={relatedTours} 
            currentTourName="whale-shark-start-sumbawa"
          />
        </div>
      </section>
